									...
									<c:when test="${entity.status == 1}">
										...
										<td>
											...
											<a href="javascript:" class="btn_delete"
											   data-url="/stockIncomeBill/delete.do?id=${entity.id}">删除</a>
											<a href="javascript:" class="btn_audit"
											   data-url="/stockIncomeBill/audit.do?id=${entity.id}">审核</a>
										</td>
									</c:when>
									<c:otherwise>
										<td>
										...
										<td>
											<a href="/stockIncomeBill/billView.do?id=${entity.id}">查看</a>
										</td>
									</c:otherwise>
								</c:choose>
							</tr>
