                ...
                $.dialog.open("/product/listView.do", {
                    ...
                    close: function () {
                        ...
                        if (p) { //选中了商品,回填数据
                            ...
                            tr.find("input[tag='salePrice']").val(p.salePrice);
                            tr.find("input[tag='number']").val(1);
                            tr.find("span[tag='amount']").html(p.salePrice.toFixed(2));
                        }
                    }
                });
            });
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" bstockOutcome="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <select class="ui_select03 client" name="client.id">
                ...
                <script type="text/javascript">
                    ...
                    $(".client option[value='${entity.client.id}']").prop("selected", true);
                </script>
                <tr>
